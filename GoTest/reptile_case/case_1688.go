...
func DownloadFile(url string, filename string) (ok bool) {
	...
	filename = "D:/golang/img/" + filename
	// 写出数据
...
func main() {
	// myTest()
	// DownloadFile("https://uploadfile.bizhizu.cn/2015/1209/20151209110048977.jpg", "1.jpg")
	...
	for i := 1; i < 27; i++ {
		...
		go getImgUrls("https://www.1688.com/")
	}
